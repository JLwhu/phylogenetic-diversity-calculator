...
public class SimpleKMeansExtension extends RandomizableClusterer implements
...
//	private Instances m_ClusterCentroids;
	protected Instances m_ClusterCentroids;  //To extend SimpleKMeansExtension, changed by Jing Liu 8/26/2013
...
//	private int[][][] m_ClusterNominalCounts;
	protected int[][][] m_ClusterNominalCounts; //To extend SimpleKMeansExtension, changed by Jing Liu 8/26/2013
//	private int[][] m_ClusterMissingCounts;
	protected int[][] m_ClusterMissingCounts; //To extend SimpleKMeansExtension, changed by Jing Liu 8/26/2013
...
//	private boolean m_PreserveOrder = false;
	protected boolean m_PreserveOrder = false;  //To extend SimpleKMeansExtension, changed by Jing Liu 8/26/2013
	...
	public void buildClusterer(Instances data) throws Exception {
		...
		fout = new FileWriter("centerstatistics1.txt");
	...
	//	m_FullMeansOrMediansOrModes = moveCentroid(0, instances, false);
		...
		m_ClusterNominalCounts = new int[m_NumClusters][instances
				.numAttributes()][0];
		m_ClusterMissingCounts = new int[m_NumClusters][instances
				.numAttributes()];
		while (!converged) {
			emptyClusterCount = 0;
			m_Iterations++;
			...
			HashMap distinctMap = is.distinctMemberNumber(m_ClusterCentroids);

			fout.write("Iteration="+m_Iterations+"\r\n");
			fout.write("Cluster Number="+m_NumClusters+"\r\n");
			...
			System.out.println("Cluster Number="+m_NumClusters);
	...
	public void setDistanceFunction(DistanceFunction df) throws Exception {
		/*commented by Jing Liu 8/19/2013  
		 * To deal with the community distance
	...
	public void setOptions(String[] options) throws Exception {
		...
		if (distFunctionClass.length() != 0) {
			String distFunctionClassSpec[] = Utils
					.splitOptions(distFunctionClass);
			if (distFunctionClassSpec.length == 0) {
				throw new Exception(
						"Invalid DistanceFunction specification string.");
			}
